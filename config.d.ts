...
export interface ApiMetadata {
  ...
  endPoints?: {
    ...
    actions?: {
      ...
      /**
       * A method in the Azure function that handle post request
       */
      post?: {
        /**
         * The name of the request model as defined in the models section
      ...
      /**
       * A method in the Azure function that handle put request
       */
      put?: {
        /**
         * The name of the request model as defined in the models section
      ...
      /**
       * A method in the Azure function that handle PATCH request
       */
      patch?: {
        /**
         * The name of the request model as defined in the models section
      ...
      /**
       * A method in the Azure function that handle delete request and filtering
       */
      delete?: {
        /**
         * Include a single record deletion using singularity parameter
         */
        implementSingularity?: boolean;
        /**
         * The name of the request model as defined in the models section
